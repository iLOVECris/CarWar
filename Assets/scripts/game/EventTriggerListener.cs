...
{
    public delegate void VoidDelegate(GameObject go, float pos = 0.0f);
    ...
    public override void OnDrag(PointerEventData eventData)
    {
        if(onDrag != null)
        {
            onDrag(gameObject,eventData.position.x);
        }
    }

    public static EventTriggerListener AddEventListener(GameObject go)
    {
